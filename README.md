# Full featured NFT Marketplace v1

Smart contracts that allow the flexible auction and sell, buy of NFTs


This repository contains the smart contracts source code for the full featured NFT Marketplace. The repository uses Hardhat as development enviroment for compilation, testing and deployment tasks.

## How does the NFT Marketplace functionality work?
...
# Bidders can perform the following actions using the NFT Marketplace contract:
